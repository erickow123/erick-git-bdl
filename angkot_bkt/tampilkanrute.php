...
// $id_angkot = $_GET['id_angkot'];
$sql = "select angkot.*, angkot_color.color , ST_ASWKB(angkot.geom) as wkb from angkot left join angkot_color on angkot.id_color = angkot_color.id where angkot.id = '$_GET[id_angkot]'";
// var_dump($sql);
// die();
